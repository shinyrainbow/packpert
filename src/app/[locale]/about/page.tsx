...
export default async function AboutPage() {
  ...
  return (
    <>
      {/* Banner Section */}
      <section
        className="relative min-h-[500px] flex items-center -mt-20 pt-20 pb-24 bg-cover bg-center"
        style={{
          backgroundImage:
            "linear-gradient(rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.3) 70%, rgba(255, 255, 255, 1) 100%), url('/about-packpert.png')",
        }}
      >
