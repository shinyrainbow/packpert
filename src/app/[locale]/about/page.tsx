    ...
    <>
      ...
      <section className="relative min-h-[500px] lg:min-h-[600px] flex items-center -mt-20 pt-20 pb-24">
        ...
        <div className="w-full px-8 lg:px-20 relative z-10">
          <div className="max-w-xl text-white text-left lg:ml-16">
            ...
            <div className="flex flex-col sm:flex-row gap-3 animate-fade-in-up-delay-2">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-[#06C755] hover:bg-[#05b34c] text-white px-6 py-4 rounded-xl font-medium transition-colors flex-1 sm:flex-none sm:min-w-[220px]"
              >
              ...
              <Link
                href={`/${locale}/contact`}
                className="inline-flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-primary px-6 py-4 rounded-xl font-medium transition-colors flex-1 sm:flex-none sm:min-w-[220px]"
              >
